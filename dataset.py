...
from utils import warmup_linear, find_start_end_after_tokenized, find_start_end_before_tokenized, bundle_part_to_batch, fuzzy_retrieve, fuzz
...
def homebrew_data_loader(bundles, mode : '#1 or #2' = '#1', batch_size = 8):
    ...
    Args:
        ...
        mode (string, optional): Defaults to '#1'. '#1' represents dataloader for task #1,
            '#2' represents dataloader for task #2.
    ...
    if mode == '#2':
        ...
        raise ValueError('mode must be "#2" or "#1"!')
